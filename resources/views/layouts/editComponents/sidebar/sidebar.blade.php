    ...
    <div class="" >
        <ul class="list-group flex-column  first-menu">
            ...
            <li class="">
                ...
                <ul class="list-group flex-column  submenu" style="display:none;width:400px;padding:20px;">
                        ...
                        <a href="#" class="">
                            ...
                            <ul class="list-group flex-column d-inline-block sub-submenu">
                                ...
                                <li class=" px-2 py-2 theme-menu buttonStyle">
                                    ...
                                    <svg onclick="showBtnStyle(this)" id="downArrow" class=""
                                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                                        <path
                                            d="M201.4 342.6c12.5 12.5 32.8 12.5 45.3 0l160-160c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L224 274.7 86.6 137.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l160 160z" />
                                    </svg>
                                    <svg onclick=" hightBtnStyle(this)" id="upArrow" class=""
            ...
            <li class="list-group-item ">
                ...
                <ul class="list-group flex-column submenu" style="display:none;width:400px;">
                    ...
                    <li class="px-1">
                        <div style="display:flex; justify-content:center;">
                            <a style="border-bottom: 1px solid gray; padding: 15px 35px; font-weight: 500;"
                                href="#" class="">PAGES</a>
                            <a style="border-bottom: 1px solid gray; padding: 15px 35px; font-weight: 500;"
                                href="#" class="">POPUPS</a>
                        </div>
            ...
            <li class="list-group-item ">
                <span onclick="openSubContent(this)">
                    ...
                    <br /><span class="align-middle"><small>CONTENT</small></span></span>
            ...
            <li class="list-group-item ">
                <span onclick="openSubContent(this)">
                    ...
                    <br /><span class="align-middle"><small>PERSONALIZE</small></span></span>
                <ul class="list-group flex-column  submenu" style="display:none;width:480px;">
                    <li class="submenu-head">
            ...
            <li class="list-group-item ">
                <span onclick="openSubContent(this)">
                    ...
                    <br /><span class="align-middle"><small>ECOMMERCE</small></span></span>
                <ul class="list-group flex-column submenu" style="display:none;width:480px;">
                    <li class="submenu-head">
                        <p>ECOMMERCE</p>
                        <p>
