    ...
    <div class="sidebar" style="">
      <ul class="list-group flex-column d-inline-block first-menu">
        ...
        <li class="list-group-item ">
          <span style="text-align: center" onclick="openSubContent(this)">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
              <path
                d="M512 256c0 .9 0 1.8 0 2.7c-.4 36.5-33.6 61.3-70.1 61.3H344c-26.5 0-48 21.5-48 48c0 3.4 .4 6.7 1 9.9c2.1 10.2 6.5 20 10.8 29.9c6.1 13.8 12.1 27.5 12.1 42c0 31.8-21.6 60.7-53.4 62c-3.5 .1-7 .2-10.6 .2C114.6 512 0 397.4 0 256S114.6 0 256 0S512 114.6 512 256zM128 288a32 32 0 1 0 -64 0 32 32 0 1 0 64 0zm0-96a32 32 0 1 0 0-64 32 32 0 1 0 0 64zM288 96a32 32 0 1 0 -64 0 32 32 0 1 0 64 0zm96 96a32 32 0 1 0 0-64 32 32 0 1 0 0 64z" />
            </svg>
            <br /><span class="align-middle"><small>THEME</small></span></span>
          <ul class="list-group flex-column d-inline-block submenu" style="display:none;width:400px;">
                    ...
                    <div style="background-color: white;" class=" ">
                      ...
                      <div class="fontSizeDrop">
                        ...
                        <div style="display: flex; align-items: center;" class="FontFormat">
                          <p style="text-decoration: underline; color: tomato; " class="p-1">U</p>
              ...
              <a href="#" class="">
                ...
                <ul class="list-group flex-column d-inline-block sub-submenu">
                  ...
                  <li class=" px-2 py-2 theme-menu buttonStyle">
                    ...
                    <svg onclick="showBtnStyle(this)" id="downArrow" class="" xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 448 512">
                      <path
                        d="M201.4 342.6c12.5 12.5 32.8 12.5 45.3 0l160-160c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L224 274.7 86.6 137.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l160 160z" />
                    </svg>
                    <svg onclick=" hightBtnStyle(this)" id="upArrow" class="" xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 512 512">
                      <path
        ...
        <li class="list-group-item ">
          <span onclick="openSubContent(this)">
            ...
            </svg><br /><span class="align-middle"><small>PAGES</small></span></span>
          <ul class="list-group flex-column d-inline-block submenu" style="display:none;">
            <li class="submenu-head">
            ...
            <li class="px-1">
              <div style="display:flex; justify-content:center;">
                <a style="border-bottom: 1px solid gray; padding: 15px 35px; font-weight: 500;" href="#"
                  class="">PAGES</a>
                <a style="border-bottom: 1px solid gray; padding: 15px 35px; font-weight: 500;" href="#"
                  class="">POPUPS</a>
              </div>
        ...
        <li class="list-group-item ">
          <span onclick="openSubContent(this)">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
              <path
                d="M240 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H32c-17.7 0-32 14.3-32 32s14.3 32 32 32H176V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H384c17.7 0 32-14.3 32-32s-14.3-32-32-32H240V80z" />
            </svg><br /><span class="align-middle"><small>WIDGETS</small></span>
          </span>
          <ul style="overflow: scroll;display:none;" class="list-group flex-column  submenu">
            <li class="submenu-head">
              <p>WIDGETS</p>
              <p>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
        ...
        <li class="list-group-item ">
          <span onclick="openSubContent(this)"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
              <path
                d="M0 96C0 60.7 28.7 32 64 32H196.1c19.1 0 37.4 7.6 50.9 21.1L289.9 96H448c35.3 0 64 28.7 64 64V416c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V96zM64 80c-8.8 0-16 7.2-16 16V416c0 8.8 7.2 16 16 16H448c8.8 0 16-7.2 16-16V160c0-8.8-7.2-16-16-16H286.6c-10.6 0-20.8-4.2-28.3-11.7L213.1 87c-4.5-4.5-10.6-7-17-7H64z" />
            </svg><br /><span class="align-middle"><small>CONTENT</small></span></span>
          ...
          <ul class="list-group flex-column d-inline-block submenu" style="display:none;">
            ...
            <li class="list-group-item px-2">
              <p style="font-size: 12px;">Add content by importing it from a website or collecting it from your
                customer.</p>
            </li>
        ...
        <li class="list-group-item ">
          <span onclick="openSubContent(this)"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
              <path
                d="M384 160c-17.7 0-32-14.3-32-32s14.3-32 32-32H544c17.7 0 32 14.3 32 32V288c0 17.7-14.3 32-32 32s-32-14.3-32-32V205.3L342.6 374.6c-12.5 12.5-32.8 12.5-45.3 0L192 269.3 54.6 406.6c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3l160-160c12.5-12.5 32.8-12.5 45.3 0L320 306.7 466.7 160H384z" />
            </svg><br /><span class="align-middle"><small>PERSONALIZE</small></span></span>
          <ul class="list-group flex-column d-inline-block submenu" style="display:none;">
            <li class="submenu-head">
        ...
        <li class="list-group-item ">
          <span onclick="openSubContent(this)"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
            ...
            </svg><br /><span class="align-middle"><small>ECOMMERCE</small></span></span>
          <ul class="list-group flex-column d-inline-block submenu" style="display:none;">
            <li class="submenu-head">
              <p>ECOMMERCE</p>
              <p>
        ...
        <li class="list-group-item ">
          <span onclick="openSubContent(this)"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
              <path
            ...
            </svg><br /><span class="align-middle"><small>MEMVERSHIP</small></span></span>
          <ul class="list-group flex-column d-inline-block submenu" style="display:none;">
            <li class="submenu-head">
              <p>MEMBERSHIP</p>
              <p>
        ...
        <li class="list-group-item ">
          <span onclick="openSubContent(this)"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
            ...
            </svg><br /><span class="align-middle"><small>BLOG</small></span></span>
          <ul class="list-group flex-column d-inline-block submenu" style="display:none;">
            <li class="submenu-head">
              <p>MANAGE BLOG</p>
              <p>
        ...
        <li class="list-group-item ">
          <span onclick="openSubContent(this)"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
            ...
            </svg><br /><span class="align-middle"><small>APP STORE</small></span></span>
          <ul class="list-group flex-column d-inline-block submenu" style="display:none;">
            <li class="submenu-head">
              <p>APP STORE</p>
              <p>
        ...
        <li class="list-group-item ">
          <span onclick="openSubContent(this)"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
              <path
                d="M481.9 166.6c3.2 8.7 .5 18.4-6.4 24.6l-30.9 28.1c-7.7 7.1-11.4 17.5-10.9 27.9c.1 2.9 .2 5.8 .2 8.8s-.1 5.9-.2 8.8c-.5 10.5 3.1 20.9 10.9 27.9l30.9 28.1c6.9 6.2 9.6 15.9 6.4 24.6c-4.4 11.9-9.7 23.3-15.8 34.3l-4.7 8.1c-6.6 11-14 21.4-22.1 31.2c-5.9 7.2-15.7 9.6-24.5 6.8l-39.7-12.6c-10-3.2-20.8-1.1-29.7 4.6c-4.9 3.1-9.9 6.1-15.1 8.7c-9.3 4.8-16.5 13.2-18.8 23.4l-8.9 40.7c-2 9.1-9 16.3-18.2 17.8c-13.8 2.3-28 3.5-42.5 3.5s-28.7-1.2-42.5-3.5c-9.2-1.5-16.2-8.7-18.2-17.8l-8.9-40.7c-2.2-10.2-9.5-18.6-18.8-23.4c-5.2-2.7-10.2-5.6-15.1-8.7c-8.8-5.7-19.7-7.8-29.7-4.6L69.1 425.9c-8.8 2.8-18.6 .3-24.5-6.8c-8.1-9.8-15.5-20.2-22.1-31.2l-4.7-8.1c-6.1-11-11.4-22.4-15.8-34.3c-3.2-8.7-.5-18.4 6.4-24.6l30.9-28.1c7.7-7.1 11.4-17.5 10.9-27.9c-.1-2.9-.2-5.8-.2-8.8s.1-5.9 .2-8.8c.5-10.5-3.1-20.9-10.9-27.9L8.4 191.2c-6.9-6.2-9.6-15.9-6.4-24.6c4.4-11.9 9.7-23.3 15.8-34.3l4.7-8.1c6.6-11 14-21.4 22.1-31.2c5.9-7.2 15.7-9.6 24.5-6.8l39.7 12.6c10 3.2 20.8 1.1 29.7-4.6c4.9-3.1 9.9-6.1 15.1-8.7c9.3-4.8 16.5-13.2 18.8-23.4l8.9-40.7c2-9.1 9-16.3 18.2-17.8C213.3 1.2 227.5 0 242 0s28.7 1.2 42.5 3.5c9.2 1.5 16.2 8.7 18.2 17.8l8.9 40.7c2.2 10.2 9.4 18.6 18.8 23.4c5.2 2.7 10.2 5.6 15.1 8.7c8.8 5.7 19.7 7.7 29.7 4.6l39.7-12.6c8.8-2.8 18.6-.3 24.5 6.8c8.1 9.8 15.5 20.2 22.1 31.2l4.7 8.1c6.1 11 11.4 22.4 15.8 34.3zM242 336a80 80 0 1 0 0-160 80 80 0 1 0 0 160z" />
            </svg><br /><span class="align-middle"><small>SEO & SETTINGS</small></span></span>
          <ul class="list-group flex-column  submenu" style="display:none;">
            <li class="submenu-head">
              <p>SEO & SETTINGS</p>
              <p>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
